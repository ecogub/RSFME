...
ggsave_hess(filename = here('paper','figures', 'fig04_hbef_ca_cq.png'), width = HESS_SINGLE_COL_CM, height = HESS_SINGLE_COL_CM)
...
dn %>%
    ...
    scale_color_manual(values = season_colors)
ggsave_hess(filename = here('paper','figures', 'fig04_hbef_no3_cq.png'), width = HESS_SINGLE_COL_CM, height = HESS_SINGLE_COL_CM)
...
ggsave_hess(filename = here('paper','figures', 'fig02_hbef_chem_ts.png'))
...
ggsave_hess(filename = here('paper','figures', 'fig05_plynlimon_ca_cq.png'), width = HESS_SINGLE_COL_CM, height = HESS_SINGLE_COL_CM)
...
d %>%
    ...
    theme(legend.position = 'none')+
    scale_color_manual(values = season_colors)
ggsave_hess(filename = here('paper','figures', 'fig05_plynlimon_no3_cq.png'), width = HESS_SINGLE_COL_CM, height = HESS_SINGLE_COL_CM)
...
ggsave_hess(filename = here('paper','figures', 'fig02_plynlimon_chem_ts.png'))
...
ggsave_hess(filename = here('paper','figures', 'fig03_plynlimon_streamflow.png'))
